...
There are 6100 census blocks in the the napa City metropolitan area. We only have trip generation data for 4079 census blocks, so we know that many of those don't have any jobs or workers in them (for instance, some of them are mostly water).
